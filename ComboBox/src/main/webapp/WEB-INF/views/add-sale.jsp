	...
	<table>
        <tr>
			...
			<td><select name="customerid" id="customerid"
				onchange="fillCustomerDetails()" required>
		...
		<tr>
			...
			<td><select name="itemid" id="itemid"
				onchange="fillItemDetails()" required>
					<option value="">--Select--</option>
					<c:forEach var="i" items="${items}">
		...
		<tr>
			<th>Tax :</th>
			<td><input type="text" name="tax" id="tax" readonly></td>
		</tr>
		<tr>
			<th>Discount :</th>
		...
		<tr>
			<th></th>
			<td><button type="submit">Add Sale</button></td>
		</tr>
	</table>
	</form>
